...
* Record a video explanation of the following methods, and send the video in a DM to your instructors:
  * Market #vendors_that_sell (iteration 2)
  * Market #total_inventory (iteration 3)
...
You need to complete at least 2 of the 3 methods in order to pass this Independent Challenge (including all methods from Iteration 1 and 2.).  You MUST complete #total_inventory.  You may choose to complete one (or both) of #overstocked_items or #sorted_item_list.
